...
def run_gift_birthday_scenario(
    *,
    ...
    turns = [
        ...
        _turn(agent, "那再帮我给女朋友选生日礼物做一个推荐。", "round2_task"),
        _turn(agent, "不是，我想换个非首饰品类。", "preference_change"),
        _turn(agent, "那再帮我给女朋友选生日礼物做一个新的推荐。", "round3_task"),
    ...
    return [
        {
            ...
            "highlight": "空白状态完成任务；用户明确反馈后形成可展示记忆。",
    ...
    return [
        {
            ...
            "title": "形成送礼记忆",
            "turn_ids": [turns[1]["id"], turns[2]["id"], turns[3]["id"]],
            "highlight": "用户给出复杂约束后，系统形成并展示当前记忆。",
            "actions": ["process_message", "extract_memory", "show_memory"],
